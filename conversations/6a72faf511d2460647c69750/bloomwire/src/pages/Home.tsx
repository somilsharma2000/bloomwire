            ...
            {instaImages.map((img) => (
              ...
              >
                <img
                  ...
                  loading="lazy"
                />
                <div className="absolute inset-0 bg-bloom-rose/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center text-[#2d2418]">
