  ...
  const sections = [
      ...
      content: (
        <div className="space-y-3 text-gray-300 leading-relaxed text-sm sm:text-base">
          ...
          <ul className="list-disc pl-5 space-y-2 text-gray-300">
            <li>
              <strong className="text-white font-medium">Personal & Contact Details:</strong> Your full name, email address, phone number, and delivery address provided during registration or checkout.
            </li>
            <li>
              <strong className="text-white font-medium">Order History:</strong> Details of handcrafted flower bouquets, DIY kits, custom arrangements, and accessories you have purchased.
            </li>
            <li>
              <strong className="text-white font-medium">Petals Balance & Rewards Activity:</strong> Information regarding your loyalty points (Petals), daily check-in streaks, reward redemptions, and referral participation.
            </li>
            <li>
              <strong className="text-white font-medium">Browsing & Technical Data:</strong> IP address, device type, browser specifications, pages visited, and interaction timestamps.
            </li>
          </ul>
        </div>
      ),
    },
    {
      ...
      content: (
        <div className="space-y-3 text-gray-300 leading-relaxed text-sm sm:text-base">
          ...
          <ul className="list-disc pl-5 space-y-2 text-gray-300">
            <li><strong className="text-white font-medium">Order Fulfillment:</strong> Processing transactions, crafting made-to-order items, and dispatching packages to your address.</li>
            <li><strong className="text-white font-medium">Customer Communication:</strong> Sending order confirmations, WhatsApp tracking updates, delivery notifications, and customer support responses.</li>
            <li><strong className="text-white font-medium">Rewards & Creator Programs:</strong> Calculating Petals, applying discounts, verifying referral actions, and managing creator payouts.</li>
            <li><strong className="text-white font-medium">Analytics & Improvements:</strong> Understanding popular arrangements and enhancing website navigation and overall user experience.</li>
          </ul>
        </div>
      ),
    },
    {
      ...
      content: (
        <div className="space-y-3 text-gray-300 leading-relaxed text-sm sm:text-base">
          ...
          <ul className="list-disc pl-5 space-y-2 text-gray-300">
            <li><strong className="text-white font-medium">Couriers for Shipping:</strong> Delivery partners (e.g. Delhivery, Bluedart, Speed Post) receive your name, address, and phone number exclusively for shipping your parcel.</li>
            <li><strong className="text-white font-medium">Payment Processors:</strong> PCI-DSS compliant gateways (such as Razorpay) process card, UPI, or net banking credentials securely. Bloomwire™ does not store sensitive card or banking credentials on our servers.</li>
          </ul>
        </div>
      ),
    },
    {
      ...
      content: (
        <div className="space-y-3 text-gray-300 leading-relaxed text-sm sm:text-base">
          <p>
            We implement robust administrative, technical, and physical security measures—including TLS encryption for data in transit and secured databases—to protect your personal information against unauthorized access, loss, or alteration.
          </p>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-3 text-gray-300 leading-relaxed text-sm sm:text-base">
          ...
          <ul className="list-disc pl-5 space-y-2 text-gray-300">
            <li><strong className="text-white font-medium">Essential Cookies:</strong> Required to maintain your active login session, cart items, and wishlist preferences.</li>
            <li><strong className="text-white font-medium">Analytics Cookies:</strong> Help us measure site traffic patterns and popular flower categories without identifying individual visitors.</li>
          </ul>
          <p>
      ...
      content: (
        <div className="space-y-3 text-gray-300 leading-relaxed text-sm sm:text-base">
          ...
          <p>
            ...
            <a href="mailto:hello@bloomwire.in" className="text-bloom-rose underline hover:text-white transition-colors">
              hello@bloomwire.in
            </a>.
          </p>
        </div>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-3 text-gray-300 leading-relaxed text-sm sm:text-base">
          ...
          <ul className="list-disc pl-5 space-y-2 text-gray-300">
            <li><strong className="text-white font-medium">Right to Access:</strong> Request a digital summary of the personal data we store about you.</li>
            <li><strong className="text-white font-medium">Right to Correction:</strong> Request updates or corrections to incomplete or inaccurate personal records.</li>
            <li><strong className="text-white font-medium">Right to Deletion:</strong> Request permanent deletion of your account and personal details.</li>
          </ul>
          <p>
            To exercise any of these rights, email us at{' '}
            <a href="mailto:hello@bloomwire.in" className="text-bloom-neon font-medium underline hover:text-white transition-colors">
              hello@bloomwire.in
            </a>.
          </p>
        </div>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-3 text-gray-300 leading-relaxed text-sm sm:text-base">
          ...
          <div className="p-4 rounded-xl glass border border-white/10 space-y-2 text-sm mt-3">
            <p className="font-semibold text-white">Bloomwire™ Grievance Redressal</p>
  ...
  return (
    <div className="min-h-screen py-12 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-xs text-gray-500 mt-3">Last Updated: August 2026 · Jaipur, Rajasthan, India</p>
      </div>

      {/* Table of Contents Quick Nav */}
      <div className="glass-dark rounded-2xl p-6 border border-white/10 mb-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2.5 text-xs text-gray-300">
          {sections.map((sec) => (
            <a
              key={sec.id}
              href={`#${sec.id}`}
              className="flex items-center gap-2 p-2 rounded-lg hover:bg-white/5 transition-colors hover:text-bloom-neon truncate"
            >
              <span className="w-5 h-5 rounded-full bg-white/10 text-white flex items-center justify-center text-[10px] font-bold flex-shrink-0">
                {sec.num}
              </span>
        ...
        {sections.map((sec) => {
          ...
          return (
            <section
              key={sec.id}
              id={sec.id}
              className="glass rounded-2xl p-6 sm:p-8 border border-white/10 hover:border-white/20 transition-all duration-300 scroll-mt-24"
            >
